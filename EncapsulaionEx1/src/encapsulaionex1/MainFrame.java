...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void btnCalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalActionPerformed
        p.setWeight(Double.parseDouble(txtWt.getText()));
        p.setHeight(Double.parseDouble(txtHt.getText()));

        p.calculateBmi();
        txtBmi.setText(p.getBmi().toString());
        p.categorizeBmi();

        txtMsg.setText(p.getMsg());
